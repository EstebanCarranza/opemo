...
class ciudad extends Seeder
{
    ...
    {           
        ...
        DB::table('tbl_ciudad')->insert(array('titulo'=>'Apodaca','idEstado'=>18));
        ...
        DB::table('tbl_ciudad')->insert(array('titulo'=>'García','idEstado'=>18));
        DB::table('tbl_ciudad')->insert(array('titulo'=>'General Bravo','idEstado'=>18));
        DB::table('tbl_ciudad')->insert(array('titulo'=>'General Escobedo','idEstado'=>18));
        ...
        DB::table('tbl_ciudad')->insert(array('titulo'=>'Guadalupe','idEstado'=>18));
        ...
        DB::table('tbl_ciudad')->insert(array('titulo'=>'Monterrey','idEstado'=>18));
        ...
        DB::table('tbl_ciudad')->insert(array('titulo'=>'San Nicolás de los Garza','idEstado'=>18));
        DB::table('tbl_ciudad')->insert(array('titulo'=>'San Pedro Garza García','idEstado'=>18));
        DB::table('tbl_ciudad')->insert(array('titulo'=>'Santa Catarina','idEstado'=>18));
